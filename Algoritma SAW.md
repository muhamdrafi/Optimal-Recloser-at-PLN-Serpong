# Analisis Singkat Program dan Hubungan Pada Algoritma SAW
...
Secara konsep, program mengambil keputusan berdasarkan multi-kriteria yang ditimbang secara deterministik.

A. Metode yang Secara Langsung Relevan
- Multi-Criteria Decision Making (MCDM)
  Program sudah sepenuhnya MCDM, dalam bentuk deterministik berbobot langsung (Simple Additive Weighting / SAW).

  Nama metode yang relevan ialah: Simple Additive Weighting (SAW)
    - SAW menggunakan normalisasi + bobot + penjumlahan tertimbang untuk menghasilkan skor akhir.
...
- Reliability Indices Calculation (IEEE 1366-2012 Standard)
  ...
  - Kenapa relevan:
    ...
    2. Perhitungan sebelum dan sesudah RC sudah sesuai struktur “interruption hours × customers / total customers”
